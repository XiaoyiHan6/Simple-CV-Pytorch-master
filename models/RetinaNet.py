...
from data.config import checkpoint_path
...
model_urls = {
    'resnet18_retinanet':
        '{}/resnet18-5c106cde.pth'.format(checkpoint_path),
    'resnet34_retinanet':
        '{}/resnet34-333f7ec4.pth'.format(checkpoint_path),
    'resnet50_retinanet':
        '{}/resnet50-19c8e357.pth'.format(checkpoint_path),
    'resnet101_retinanet':
        '{}/resnet101-5d3b4d8f.pth'.format(checkpoint_path),
    'resnet152_retinanet':
        '{}/resnet152-b121ed2d.pth'.format(checkpoint_path),
}
