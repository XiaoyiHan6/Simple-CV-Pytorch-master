...
from utils.path import log, Results, CheckPoints, detection_evaluate, detection_eval_log
...
class set_config(object):
    ...
    if cfg['DATA']['NAME'] == 'COCO':
        ...
        dataset_eval = COCODetection(cfg['DATA']['ROOT'], image_set='val2017')
        ...
        dataset_eval = VOCDetection(cfg['DATA']['ROOT'], image_sets=[('2007', 'test')])
    else:
