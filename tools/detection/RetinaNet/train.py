...
def train():
    ...
    dataset_train = None
    if args.model == 'retinanet':
        dataloader_train = DataLoader(dataset_train, num_workers=args.num_workers, collate_fn=retinanet_collate,
                                      batch_sampler=sampler)
    elif args.model == 'ssd':
        dataset_train = DataLoader(dataset_train, num_workers=args.num_workers, collate_fn=ssd_collate,
                                   batch_sampler=sampler)
    else:
        raise ValueError("DataLoader Error!")
