...
from data.detection.SSD.voc0712 import VOC_ROOT
...
def do_python_eval(output_dir='output', use_07=True):
    # /data/PycharmProject/Simple-CV-Pytorch-master-master/results/SSD/VOC/annot_cache (annotations_cache)
    cachedir = os.path.join(devkit_path, 'SSD/VOC')
    aps = []
...
"""
    ...
    if not os.path.isdir(cachedir):
        os.mkdir(cachedir)
    # /data/PycharmProject/Simple-CV-Pytorch-master/results/SSD/VOC/annots.pkl
...
def eval_voc(dataset, net, transform, cuda):
    ...
    output_dir = get_output_dir(devkit_path, 'SSD/VOC/annot_cache')
